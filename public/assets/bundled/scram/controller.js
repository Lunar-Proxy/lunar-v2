(() => {
  ...
  (t.d = (e, r) => {
    ...
    (() => {
      let e = Symbol.for('scramjet client global'),
      ...
      '$scramjet' in self ||
        (self.$scramjet = {
          ...
          flagEnabled: function (e, r) {
            let t = c.config.flags[e];
            for (let t in c.config.siteFlags) {
              let o = c.config.siteFlags[t];
      ...
      window.ScramjetController = class {
        ...
        constructor(e) {
          let r = {
            ...
            t = (e, r) => {
              for (let o in r)
                r[o] instanceof Object && o in e && Object.assign(r[o], t(e[o], r[o]));
        ...
        encodeUrl(e) {
          return e instanceof URL && (e = e.toString()), c.config.prefix + c.codec.encode(e);
        }
        decodeUrl(e) {
