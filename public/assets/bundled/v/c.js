...
(() => {
      ...
      overrideAudio() {
        this.ctx.override(
          ...
          (t, r, e) => {
            ...
            let [n] = e,
              o = new a({ url: n }, t, r);
            return this.emit('audio', o), o.intercepted ? o.returnValue : new o.target(o.data.url);
          },
          !0,
        );
      }
  ...
  var D = class extends de.default {
      ...
      overrideToString() {
        this.ctx.override(this.fnProto, 'toString', (t, r) => {
          ...
          return this.emit('toString', e), e.intercepted ? e.returnValue : e.target.call(e.data.fn);
        });
      }
    },
    pe = D;
  ...
  var N = class extends fe.default {
      ...
      overrideGetPropertyNames() {
        this.ctx.override(this.Object, 'getOwnPropertyNames', (t, r, e) => {
          ...
          return this.emit('getOwnPropertyNames', o), o.intercepted ? o.returnValue : o.data.names;
        });
      }
      ...
      overrideHeaders() {
        return this.Headers
          ? (this.ctx.overrideDescriptor(this.reqProto, 'headers', {
              get: (t, r) => {
                let e = new a({ value: t.call(r) }, t, r);
                return this.emit('requestHeaders', e), e.intercepted ? e.returnValue : e.data.value;
              },
            }),
            this.ctx.overrideDescriptor(this.resProto, 'headers', {
              get: (t, r) => {
                let e = new a({ value: t.call(r) }, t, r);
                return (
                  this.emit('responseHeaders', e), e.intercepted ? e.returnValue : e.data.value
                );
              },
            }),
  ...
  var V = class extends ye.default {
      ...
      overrideSend() {
        this.ctx.override(this.xhrProto, 'send', (t, r, [e = null]) => {
          ...
          return (
            this.emit('send', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.body)
          );
        });
      }
      ...
      overrideGetResHeaders() {
        this.ctx.override(this.xhrProto, 'getAllResponseHeaders', (t, r) => {
          let e = new a({ value: t.call(r) }, t, r);
          return (
            this.emit('getAllResponseHeaders', e), e.intercepted ? e.returnValue : e.data.value
          );
        });
      }
  ...
  var I = class extends xe.default {
      ...
      overrideGo() {
        this.ctx.override(this.historyProto, 'go', (t, r, [e]) => {
          ...
          return (
            this.emit('go', n), n.intercepted ? n.returnValue : n.target.call(n.that, n.data.delta)
          );
        });
      }
      overrideForward() {
  ...
  function Ce(s, t, r) {
    console.error(`error while processing '${r}': `, t), s.postMessage({ type: 'error', error: t });
  }
  var b = class {
    constructor(t) {
      this.worker = new j(t);
      ...
      emulate(t, r = {}) {
        ...
        let e = new this.ctx.window.Proxy(r, {
          ...
          set: (n, o, i) => {
            ...
            return (
              this.emit('set', c), c.intercepted ? c.returnValue : (t[c.data.name] = c.data.value)
            );
          },
          deleteProperty: (n, o) => {
        ...
        return (
          this.wrappers.set(e, t), this.ctx.nativeMethods.setPrototypeOf(e, this.storeProto), e
        );
      }
    },
    je = F;
