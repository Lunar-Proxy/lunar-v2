(() => {
  var e = {
                ...
                if (o.iswindow) {
                  ...
                  if (e) {
                    let r = e.getAttribute('href'),
                      o = r.indexOf('#');
                    if (!(r = r.substring(0, -1 === o ? void 0 : o))) return t.url;
          ...
          get frame() {
            ...
            if (!t) {
              ...
              for (; e.parent !== e; ) {
                ...
                if (e.frameElement && e.frameElement[n.D]) return e.frameElement[n.D];
                e = e.parent.window;
              }
            }
            return t;
              ...
              (n.construct = function (e, t, o) {
                ...
                let a = !1,
                  s = {
                    ...
                    call: () => ((a = !0), (n = Reflect.construct(s.fn, s.args, s.newTarget))),
                  };
                return (r.construct(s), a) ? n : Reflect.construct(s.fn, s.args, s.newTarget);
              }),
              r.apply &&
                (n.apply = function (e, t, o) {
                  ...
                  let a = !1,
                    s = {
                      ...
                      call: () => ((a = !0), (n = Reflect.apply(s.fn, s.this, s.args))),
                    },
                  ...
                  get(e, o, n) {
                    ...
                    return 'length' === o
                      ...
                      : 'getNamedItem' === o
                        ...
                        : 'getNamedItemNS' === o
                          ? (e, t) => r[`${e}:${t}`]
                          : o in NamedNodeMap.prototype && 'function' == typeof a
                            ? new Proxy(a, {
                                apply: (e, o, n) =>
                                  o === r ? Reflect.apply(e, t, n) : Reflect.apply(e, o, n),
                              })
                            : ('string' != typeof o && 'number' != typeof o) || isNaN(Number(o))
                              ? this.has(e, o)
                                ? a
                                : void 0
                              : t[Object.keys(r)[o]];
                ...
                return new Proxy(r, {
                  get(e, t) {
                    ...
                    return 'function' == typeof n
                      ? new Proxy(n, { apply: (e, t, o) => Reflect.apply(e, r, o) })
        ...
        function l(e, t) {
          ...
          e.Trap('Node.prototype.baseURI', {
                ...
                let [r, o] = t.args,
                  n = s.Gq.find((e) => {
                    ...
                    return (
                      !!o &&
                      ('*' === o ||
                        ('function' != typeof o && o.includes(t.this.tagName.toLowerCase())))
                    );
                  });
                n &&
                ...
                if (r.this instanceof t.HTMLScriptElement)
                  (n = (0, s.Zs)(o, '(anonymous script element)', e.meta)),
                    e.natives.call(
                      ...
                      btoa(Array.from(i.encode(n), (e) => String.fromCodePoint(e)).join('')),
                    );
                else if (r.this instanceof t.HTMLStyleElement) n = (0, s.U5)(o, e.meta);
                else
                  try {
            ...
            e.Trap('TreeWalker.prototype.currentNode', {
              get: (e) => e.get(),
              set: (r, o) => (o === e.documentProxy ? r.set(t.document) : r.set(o)),
            }),
      ...
      461: function (e, t, r) {
        ...
        function a(e, t) {
          e.Proxy('History.prototype.pushState', {
            apply(t) {
              (t.args[2] || '' === t.args[2]) && (t.args[2] = (0, o.dm)(t.args[2], e.meta)),
                t.call();
      ...
      4475: function (e, t, r) {
        ...
        var o = r(4471);
        function n(e, t) {
          e.Trap('PerformanceEntry.prototype.name', { get: (e) => (0, o.Sd)(e.get()) });
        }
      },
      5707: function (e, t, r) {
        'use strict';
        r.r(t), r.d(t, { default: () => l, disabled: () => i, enabled: () => s, order: () => a });
        var o = r(4471),
          n = r(8810);
        let a = 2,
          ...
          let r = {
              get(t, r) {
                switch (r) {
                  ...
                  case 'key':
                    return (r) => {
                      let o = Object.keys(t).filter((t) => t.startsWith(e.url.host));
                  ...
                  default:
                    ...
                    return console.log('GET', r, t == o), t.getItem(e.url.host + '@' + r);
                }
              },
              set: (t, r, n) => (
                t == o && console.log('SET', r, n, t === o), t.setItem(e.url.host + '@' + r, n), !0
              ),
              ownKeys: (t) =>
                Reflect.ownKeys(t)
              ...
              defineProperty: (t, r, o) => (t.setItem(e.url.host + '@' + r, o.value), !0),
            },
            o = t.localStorage,
          ...
          return (
            ...
            t.location.assign &&
              (i.assign = new Proxy(t.location.assign, {
                apply(r, o, a) {
                  (a[0] = (0, n.dm)(a[0], e.meta)), Reflect.apply(r, t.location, a);
                },
              })),
            t.location.reload &&
      ...
      3498: function (e, t, r) {
        'use strict';
        r.r(t), r.d(t, { nativeFunction: () => o, nativeGetOwnPropertyDescriptor: () => n });
        let o = self.Function,
      ...
      9447: function (e, t, r) {
        ...
        function n(e) {
          e.Proxy('URL.createObjectURL', {
            apply(t) {
              let r = t.call();
              r.startsWith('blob:') ? t.return((0, o.ls)(r, e.meta)) : t.return(r);
            },
          }),
      ...
      4423: function (e, t, r) {
        ...
        function n(e, t) {
          Object.defineProperty(t, o.vc.globals.rewritefn, {
            value: function (t) {
              return 'string' != typeof t ? t : (0, o.Zs)(t, '(direct eval proxy)', e.meta);
            },
            writable: !1,
            configurable: !1,
          });
        ...
        function a(e) {
          return 'string' != typeof e
            ? e
            : (0, this.global.eval)((0, o.Zs)(e, '(indirect eval proxy)', this.meta));
        }
      },
      8231: function (e, t, r) {
        'use strict';
        ...
        function c(e, t) {
              ...
              apply(e, o, n) {
                ...
                if (s.isTrusted) {
                  ...
                  if (t in r) {
                    ...
                    n[0] = new Proxy(s, {
                      get: (t, r, n) => (r in o ? o[r].call(t) : Reflect.get(e, r, n)),
                ...
                return (
                  t.event ||
                    Object.defineProperty(t, 'event', { get: () => n[0], configurable: !0 }),
                  Reflect.apply(e, o, n)
                );
              },
              getOwnPropertyDescriptor: a.getOwnPropertyDescriptorHandler,
          ...
          e.Proxy('EventTarget.prototype.addEventListener', {
            apply(t) {
              ...
              (n ||= []).push({ event: t.args[0], originalCallback: r, proxiedCallback: o }),
          ...
          u))
            for (let t of Reflect.ownKeys(n))
              if ('string' == typeof t && t.startsWith('on') && r[t.slice(2)]) {
                let r = (0, s.nativeGetOwnPropertyDescriptor)(n, t);
      ...
      4306: function (e, t, r) {
        ...
        function u() {
          return (
            (null === c || c.buffer !== o.memory.buffer) && (c = new Uint8Array(o.memory.buffer)), c
          );
        }
        function p(e, t) {
        ...
        function y(e, t, r) {
          ...
          if (s !== o) {
            0 !== s && (e = e.slice(s)), (n = r(n, o, (o = s + 3 * e.length), 1) >>> 0);
            let t = d(e, u().subarray(n + s, n + o));
        ...
        function h() {
          return (
            (null === m || m.buffer !== o.memory.buffer) && (m = new DataView(o.memory.buffer)), m
          );
        }
        function b(e) {
          return null == e;
        ...
        function x() {
          ...
          return (
            ...
            (e.wbg.__wbg_newwithbase_161c299e7a34e2eb = function () {
              return i(function (e, t, r, o) {
                return new URL(p(e, t), p(r, o));
              }, arguments);
            }),
            (e.wbg.__wbg_now_d18023d54d4e5500 = function (e) {
              return e.now();
            }),
            ...
            (e.wbg.__wbindgen_string_get = function (e, t) {
              ...
              var n = b(r) ? 0 : y(r, o.__wbindgen_malloc, o.__wbindgen_realloc),
                a = f;
            ...
            (e.wbg.__wbindgen_uint8_array_new = function (e, t) {
              ...
              return o.__wbindgen_free(e, +t, 1), n;
            }),
            e
          );
        }
        ...
        async function S(e, t) {
          ...
          ('string' == typeof e ||
            ...
            (e = fetch(e)),
            P(n, t);
          let { instance: a, module: s } = await v(await e, n);
          return _(a, s, r);
        }
                  ...
                  return (
                    ...
                    (function (e, t, r, n = !1) {
                      ...
                      return (0, a.Sp)('naiiveRewriter', r.origin)
                        ? ('string' !=
                            typeof (s = 'string' == typeof e ? e : new TextDecoder().decode(e)) &&
	...
	`)
                        : (function (e, t, r, n) {
                            ...
                            try {
                              s =
                                'string' == typeof e
                                  ? (function (e, t, r, n, a) {
                                      let s = y(e, o.__wbindgen_malloc, o.__wbindgen_realloc),
                                        i = f,
                                        l = y(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
                                        c = f,
                                        u = y(n, o.__wbindgen_malloc, o.__wbindgen_realloc),
                                        p = f,
                                        g = o.rewrite_js(s, i, l, c, r, u, p, a);
                                      if (g[2]) throw w(g[1]);
                                      return w(g[0]);
                                    })(e, r.base.href, n, t || '(unknown)', a.h3)
                                  : (function (e, t, r, n, a) {
                                      let s = (function (e, t) {
                                        ...
                                        l = y(t, o.__wbindgen_malloc, o.__wbindgen_realloc),
                                        c = f,
                                        p = y(n, o.__wbindgen_malloc, o.__wbindgen_realloc),
                                        g = f,
                                        d = o.rewrite_js_from_arraybuffer(s, i, l, c, r, p, g, a);
                                      if (d[2]) throw w(d[1]);
                                      return w(d[0]);
                                    })(new Uint8Array(e), r.base.href, n, t || '(unknown)', a.h3);
                            } catch (r) {
                              return (
                                console.warn('failed rewriting js for', t, r, e),
                ...
                if (e.startsWith('data:')) return location.origin + a.h3.config.prefix + e;
                {
                  ...
                  r.startsWith('about:') &&
                    (r = (function (e) {
                      ...
                      if (e.startsWith(t + 'data:')) return e.substring(t.length);
                      if (e.startsWith('mailto:') || e.startsWith('about:')) return e;
                      else if (E(e))
                  ...
                  let o = E(e, r);
                  return o ? location.origin + a.h3.config.prefix + a.h3.codec.encode(o.href) : e;
                }
              })(s, e.meta)}")`,
            )();
          }),
      ...
      106: function (e, t, r) {
        ...
        function a(e, t) {
          e.Proxy('fetch', {
            ...
            e.Trap('Response.prototype.url', { get: (e) => (0, n.Sd)(e.get()) }),
          ...
          e.Proxy('WebSocket', {
            ...
            e.Proxy('WebSocketStream', {
              construct(r) {
                ...
                let i = e.bare.createWebSocket(r.args[0], r.args[1], null, {
                  'User-Agent': t.navigator.userAgent,
                  Origin: e.url.origin,
                });
                  ...
                  readable: new ReadableStream({
                    start(e) {
                      i.addEventListener('message', (t) => {
                        let r = t.data;
                        'string' == typeof r ||
                          ('byteLength' in r && Object.setPrototypeOf(r, ArrayBuffer.prototype)),
                          e.enqueue(r);
                      });
                    },
                  }),
            ...
            e.Trap('WebSocketStream.prototype.closed', { get: (e) => o.get(e.this).closed }),
            e.Trap('WebSocketStream.prototype.opened', { get: (e) => o.get(e.this).opened }),
            e.Trap('WebSocketStream.prototype.url', { get: (e) => o.get(e.this).url }),
      ...
      7481: function (e, t, r) {
        ...
        function a(e, t) {
          ...
          e.Proxy('XMLHttpRequest.prototype.open', {
            ...
            e.Trap('XMLHttpRequest.prototype.responseURL', { get: (e) => (0, n.Sd)(e.get()) });
        }
      },
      6321: function (e, t, r) {
        'use strict';
            ...
            value: (e, t) => {
              ...
              for (let e = 0; e < i; e++) {
                ...
                if (((l += 1), 0 == e)) {
                  ...
                  l += 4;
                  let r = o.getUint32(l, !0);
                  l += 4;
                  let n = o.getUint32(l, !0);
                  ...
                  let n = o.getUint32(l, !0);
                  l += 4;
                  let i = o.getUint32(l, !0);
                  l += 4;
                  let c = a.decode(r.subarray(n, i));
        ...
        function n(e, t) {
          e.Proxy('Worker', {
            ...
            e.Proxy('Worklet.prototype.addModule', {
              apply(t) {
                t.args[0] && (t.args[0] = (0, o.dm)(t.args[0], e.meta) + '?dest=worklet');
              },
            });
        }
      },
      7706: function (e, t, r) {
        'use strict';
        r.r(t), r.d(t, { createWrapFn: () => i, default: () => c, order: () => l });
        var o = r(6707),
          n = r(9777),
          a = r(4471),
          s = r(4423);
        function i(e, t) {
          return function (r) {
            ...
            if (o.iswindow) {
              if (r === t.parent)
                return n.a in t.parent ? t.parent[n.a].globalProxy : e.globalProxy;
